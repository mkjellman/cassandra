 ...
 * backing buffer. As {@link org.apache.cassandra.io.sstable.birch.BirchReader} segments are serialized
 ...
 * @see org.apache.cassandra.io.sstable.birch.PageAlignedWriter
 * @see PageAlignedReader
 */
//public class BufferingPageAlignedReader extends AbstractReaderFileProxy implements ChunkReader
public class BufferingPageAlignedReader extends InputStream implements DataInput, AutoCloseable
{
    ...
    //public BufferingPageAlignedReader(ChannelProxy channel, long fileLength, BufferType bufferType, int bufferSize)
    public BufferingPageAlignedReader(File file, int bufferSize) throws IOException
    {
        ...
        NativeLibrary.tryDisableReadAhead(NativeLibrary.getfd(channel), 0, length);
    }
