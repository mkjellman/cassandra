...
public interface TreeSerializable
{
    ...
    /**
     * @param comparator the ClusteringComparator type to use for this key
     * @return the total serialized size (including any overhead from serialzation) of the key
     * @throws IOException failed to serialize the key to a ByteBuffer
     */
    int serializedKeySize(ClusteringComparator comparator) throws IOException;
     ...
     * @throws IOException failed to serialize the key to a ByteBuffer
     */
    ByteBuffer serializedKey(ClusteringComparator comparator) throws IOException;
