 ...
 * PageAlignedWriter implements the concepts of {@link org.apache.cassandra.io.sstable.birch.AlignedSubSegment}
 * and {@link org.apache.cassandra.io.sstable.birch.AlignedSegment}. A segment can have
...
public class PageAlignedWriter implements DataOutput, WritableByteChannel
{
    ...
    public PageAlignedWriter(File file)
    {
        ...
        this.directoryFD = NativeLibrary.tryOpenDirectory(file.getParent());
    ...
    private void maybeFsyncParentDirectory()
    {
        if (!directorySynced)
        {
            NativeLibrary.trySync(directoryFD);
    ...
    {
        close();
        // todo kj: what is this used for in trunk?
        // for now no-op
        return accumulate;
    }
