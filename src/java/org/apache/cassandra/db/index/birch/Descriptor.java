...
public class Descriptor
{
    ...
    private final int overflowPageLength;
    ...
    public static class Builder
    {
        ...
        private int overflowPageLength = 0;
        ...
        public Builder overflowPageLength(int overflowPageLength)
        {
    ...
    public int getOverflowPageLength()
    {
    ...
    public void serialize(PageAlignedWriter writer) throws IOException
    {
        ...
        writer.writeInt(overflowPageLength);
    ...
    public static Descriptor deserialize(PageAlignedReader reader) throws IOException
    {
        ...
        Builder builder = new Builder(version, alignedPageSize, serializerType)
                          ...
                          .overflowPageLength(reader.readInt())
