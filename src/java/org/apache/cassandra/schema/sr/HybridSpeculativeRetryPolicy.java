...
public class HybridSpeculativeRetryPolicy implements SpeculativeRetryPolicy
{
    ...
    private final Function comparator;

    public HybridSpeculativeRetryPolicy(PercentileSpeculativeRetryPolicy percentilePolicy,
                                        FixedSpeculativeRetryPolicy fixedPolicy, Function comparator) {
    ...
    public long calculateThreshold(Timer readLatency)
    {
        ...
        return comparator == Function.MIN
    ...
    public boolean equals(Object obj)
    {
        ...
        return comparator == rhs.comparator && Objects.equal(percentilePolicy, rhs.percentilePolicy)
    ...
    public int hashCode()
    {
        return Objects.hashCode(comparator, percentilePolicy, fixedPolicy);
    }

    @Override
    public String toString()
    {
        return String.format("%s(%s,%s)", comparator, percentilePolicy, fixedPolicy);
    }
}
