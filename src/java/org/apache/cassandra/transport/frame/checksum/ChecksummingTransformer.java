...
/**
 * Provides a format that implements chunking and checksuming logic
...
{
    public final static int DEFAULT_BLOCK_SIZE = 1 << 15; // 32k block size
     ...
     */
    public ChecksummingTransformer(int blockSize, Compressor compressor, ChecksumType checksumType)
    {
    ...
    public ByteBuf transformOutbound(ByteBuf inputBuf) throws IOException
    {
        ...
        while ((readableBytes = inputBuf.readableBytes()) > 0)
        {
            ...
            int uncompressedChunkChecksum = (int) checksumType.of(inBuf, 0, lengthToRead);
            ...
            int lengthsChecksum = (int) checksumType.of(chunkLengths, 0, 2);
     ...
     */
    public ByteBuf transformInbound(ByteBuf inputBuf) throws IOException
    {
        ...
        for (int i = 0; i < numChunks; i++)
        {
            ...
            int calculatedLengthsChecksum = (int) checksumType.of(chunkLengths, 0, 2);
            ...
            // decompress it
            byte[] decompressedChunk = compressor.decompress(buf, decompressedLength);
            ...
            int calculatedDecompressedChecksum = (int) checksumType.of(decompressedChunk, 0, decompressedChunk.length);
